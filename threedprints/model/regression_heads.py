...
class MultiTaskRegressionModel(nn.Module):
    ...
    def __init__(self, hidden_dim, output_dim, encoder: TransformerEncoder, task_list: list):
        ...
        for task_idx, _ in enumerate(task_list):
            ...
            head = nn.Sequential(nn.Linear(input_dim,hidden_dim),self.activation,nn.Linear(hidden_dim,output_dim))
