...
hyperparameter = {"batch_size":64,"masking_probability": 0.15,"epochs":1000,"learning_rate":1e-4}
...
for epoch in range(hyperparameter["epochs"]):
    ...
    for batch, (embeddings, padding_mask,regression_targets, regression_masks) in enumerate(training_loader):
    ...
    for batch, (embeddings, padding_mask,regression_targets, regression_masks) in enumerate(validation_loader):
