...
architecture_parameter = json.load(
    open(
        "/home/steffen/projects/mol_descriptors/transformer_model/adme-fang-sol/architecture_parameters.json"
    )
)

model_parameters = torch.load(
    "/home/steffen/projects/mol_descriptors/transformer_model/adme-fang-sol/regression_model.pth"
)
...
for _, (embeddings, padding_masks, _, _) in enumerate(dataloader):
...
predictions = (predictions * train_data_metadata["std"].numpy()) + train_data_metadata[
    "mean"
].numpy()
