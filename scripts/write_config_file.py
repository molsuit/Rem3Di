...
pos_encoding_config = RelativeDistancePositionalEncodingConfig(N_radial_basis_functions=16, distance_cutoff=20, d_projection=64,basis_function_type=RadialBasisFunctionType.BESSEL)
...
global_aggregator_config = GlobalAggregatorConfig(
    aggregator_type_config= mean_aggregator_config,
