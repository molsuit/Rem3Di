...
creation_config = DatasetCreationConfig(path = Path("/share/snw30/projects/threedscriptor/fast_data_preparation/data/binding_db"), N_structures=1000, max_embed_attempts=100, max_MMFF_steps=100)
...
batched_embedding = BatchedEmbeddingStage(mace_model, device = device, dtype= torch.float32)
