...
def multitask_masked_loss(predictions, labels, regression_mask):
    ...
    # print(f"Error Shape {squared_error.shape}")
    # print(f"Mask {regression_mask}")
    ...
    # print(f"Active Labels {active_labels_count}")
    ...
    # print(f"weighed loss {weighted_loss}")
    ...
    return final_loss, weighted_loss
