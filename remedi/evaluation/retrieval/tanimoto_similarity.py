...
from remedi.evaluation.retrieval.config import TanimotoSimilarityTaskConfig
from remedi.evaluation.retrieval.fingerprints import (
    bulk_tanimoto,
    morgan_fingerprints,
    tanimoto,
)
from remedi.evaluation.retrieval.vector_store import VectorStore
...
def run_tanimoto_similarity(
    ...
    fps = morgan_fingerprints(store.smiles, radius=cfg.fp_radius, n_bits=cfg.fp_n_bits)
