...
from remedi.evaluation.framework.resources import EmbeddingSpec, IndexSpec
...
from remedi.evaluation.retrieval.runner import RetrievalReport
...
class RetrievalConfig(BaseModel):
    ...
    def _build_store(self, ctx: EvalContext) -> VectorStore:
        ...
        n = (
            ...
            else min(self.max_structures, X_full.shape[0])
        )
